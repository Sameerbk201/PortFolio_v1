  ...
  return (
    <section className="max-container ">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p className="text-sm">
          A software developer and IoT engineering student at Savonia University
          of Applied Sciences. Specializing in IoT, web, and mobile development,
          I'm driven by a passion for innovation and crafting impactful
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            instrumental in my personal and professional growth, shaping me into
